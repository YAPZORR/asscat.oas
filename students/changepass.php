...
<center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-primary"><i class="fa fa-user-edit"></i> Edit User Account</h4>
            </div>
             <div class="card-body">
            ...
            <form id="change_password">
              ...
              <div class="form-group row text-left text-dark">
                ...
                <div class="col-sm-9">
                  <input class="form-control" placeholder="First Name" name="firstname" value="<?php echo $_SESSION['user1']['fname']; echo "&nbsp;";  echo $_SESSION['user1']['lname'];?>" readonly>
                </div>
              </div><br>
              <div class="form-group row text-left text-dark">
                <div class="col-sm-3" style="padding-top: 5px;">
                ...
                <div class="col-sm-9">
                  <input class="form-control" placeholder="Username" name="username" value="<?php echo $_SESSION['user1']['username']; ?>" readonly>
                </div>
              </div><br>
              <div class="form-group row text-left text-dark">
                <div class="col-sm-3" style="padding-top: 5px;">
...
$('#change_password').submit(function (e) {
  ...
  if (new_password == re_new_password && new_password != '') {
    $.ajax({
      ...
      setTimeout(function(){
        window.location.href = "mygrade.php";
